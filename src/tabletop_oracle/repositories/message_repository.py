...
with citations and context attachments eagerly loaded. Session existence
validation is included to support ownership checks upstream.
"""
...
class MessageRepository:
    ...
    and context attachments. Ordering is always by ``sequence`` (ascending
    or descending per caller preference).
